class RafflesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @raffle.save
        format.html { redirect_to raffles_url, notice: "Raffle was successfully created." }
  ...
  def update
    respond_to do |format|
      if @raffle.update(raffle_params)
        format.html { redirect_to raffle_url(@raffle), notice: "Raffle was successfully updated." }
